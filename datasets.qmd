...
<div id="listing-controls" class="listing-controls" aria-label="Catalog filters">
  <div class="filter-block search-block">
    <label for="listing-search">Search</label>
    <input type="search" id="listing-search" placeholder="Search by title, provider, topic, or description" autocomplete="off">
  </div>
